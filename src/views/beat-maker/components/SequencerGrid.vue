...
<template>
  <div
    ref="containerRef"
    class="relative w-full overflow-x-auto select-none"
    :style="{ height: `${stageH}px`, minHeight: `${stageH}px` }"
  >
    <!-- Step header labels -->
